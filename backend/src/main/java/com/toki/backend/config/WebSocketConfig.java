...
import com.toki.backend.webrtc.service.TokiUserRegistry;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    private final TokiUserRegistry tokiUserRegistry;
    ...
    public RoomHandler roomHandler() {
        return new RoomHandler(tokiRoomManager, tokiUserRegistry);
    }
